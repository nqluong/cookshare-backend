...
public class RecipeController {
    ...
    public ResponseEntity<List<RecipeResponse>> getRecipesByUserId(@PathVariable UUID userId) {
        List<RecipeResponse> responses = recipeService.getRecipesByUserId(userId);
